...
- **Automation & tooling additions:**
  ...
  - `scripts/ishtar_telos_update_helper.py` validates update requests, logs them to `memory/ishtar-telos-update.log`, and prints/records the exact `bun ... update-telos.ts` command so future updates follow the documented workflow. [[Source: scripts/ishtar_telos_update_helper.py]]
